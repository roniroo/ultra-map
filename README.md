...
GPX, and shareable links. Built to out-plan CalTopo and onX combined, on 100% free and
...
- **Share links** — the whole plan encoded in a URL, no server, no account.
...
elevation decoder, GPX parser, polyline codec, chart, and state store are hand-rolled.
